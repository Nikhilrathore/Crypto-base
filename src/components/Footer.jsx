            ...
            <div className='flex justify-evenly w-full md:max-w-[300px] uppercase'>
                <div>
                     ...
                     <ul>
                        ...
                        <li className='text-sm py-2'>Contect Us</li>
                    ...
                    <div className='w-full md:w-[300px] py-4 relative'>
                        ...
                        <div className='py-4'>
                            <form>
                                ...
                                <button className='bg-button text-btnText px-4 p-2 w-full rounded-2xl shadow-xl font-bold hover:shadow-2xl md:w-auto my-2'>Sign Up</button>
                            </form>
                        </div>
