    ...
    <div className='rounded-div my-12 py-8'>
      ...
      <div className='grid md:grid-cols-2 gap-8'>
        <div>
            ...
            <div>
                <p className='text-xl font-bold'>Market States</p>
                <div className='flex justify-between py-4'>
                    <div>
                    ...
                    <div>
                        <p className='text-gray-500 text-sm'>Hashing Algorithum</p>
                        {coin.hashing_algorithum ? <p>{coin.hashing_algorithum}</p>:null}
                    </div>
                    <div>
